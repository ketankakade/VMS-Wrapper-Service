...
public class WrapperController {
	...
	public ResponseEntity<GenericResponse<VisitorDto>> addVisitor(@Valid @RequestBody VisitorDto visitor) {
		try {
			...
			GenericResponse<VisitorDto> createVisitorGenericRes = restTemplate.postForObject(endpoint, visitor, GenericResponse.class);
	...
	public ResponseEntity<GenericResponse<VisitorDto>> listVisitors(@PathVariable Integer pageNo,
		...
		try {
			//ToDo wrapper service
			GenericResponse<VisitorDto> listVisitorGenericRes = wrapperService.listVisitors(pageNo, pageSize);
	...
	public ResponseEntity<GenericResponse<?>> deleteVisitor(@PathVariable(value = "id") Integer visitorId) {
		try {
			//ToDo wrapper service
			GenericResponse<?> deleteVisitorGenericRes = wrapperService.deleteVisitor(visitorId);
